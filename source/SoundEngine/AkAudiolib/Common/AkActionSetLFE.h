...
//
//////////////////////////////////////////////////////////////////////
#ifndef _ACTION_SET_LFE_H_
#define _ACTION_SET_LFE_H_
...
class CAkActionSetLFE : public CAkActionSetValue
{
public:
	//Thread safe version of the constructor
	static CAkActionSetLFE* Create(AkActionType in_eActionType, AkUniqueID in_ulID = 0);
...
protected:
	//Constructor
	CAkActionSetLFE(AkActionType in_eActionType, AkUniqueID in_ulID);

	//Destructor
	virtual ~CAkActionSetLFE();
