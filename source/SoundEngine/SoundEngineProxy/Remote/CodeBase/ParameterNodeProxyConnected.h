...
class ParameterNodeProxyConnected : public ParameterableProxyConnected
{
public:
	ParameterNodeProxyConnected();
	virtual ~ParameterNodeProxyConnected();

	virtual void HandleExecute( CommandDataSerializer& in_rSerializer, CommandDataSerializer& out_rReturnSerializer );

	DECLARE_BASECLASS( ParameterableProxyConnected );
};
