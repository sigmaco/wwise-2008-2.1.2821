...
class SwitchContainerProxyConnected : public ContainerProxyConnected
{
public:
	SwitchContainerProxyConnected( AkUniqueID in_id );
	virtual ~SwitchContainerProxyConnected();
...
private:
	SwitchContainerProxyLocal m_proxyLocal;
